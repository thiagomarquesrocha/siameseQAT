...
class Retrieval():
    ...
    def read_model(self):
        ...
        model = similarity_model.get_layer('merge_features_in').output
    ...
    def infer_vector(bugs, path_data):
        bug_set = self.get_bug_set()
    ...
    def run(self, path, path_buckets, path_train, path_test):
        ...
        self.infer_vector(path_train, self.train_bugs)
